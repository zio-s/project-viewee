...
const QnA = () => {
  const faq = [
    ...
    },
    {
      ...
      answer: '구독 서비스의 가격은 다음 페이지에서 확인하실 수 있습니다. <a href="/subscribe">확인하기</a>',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      answer: '뷰이 회원가입 페이지는 다음과 같습니다. <a href="/signup">회원가입</a>',
    },
    {
      id: 6,
      question: '뷰이(Viewee) 무료 체험이란 무엇인가요?',
      answer:
        '뷰이 구독 서비스를 무료로 체험해보실 수 있습니다. 자세한 내용은 다음 페이지를 참고하세요. <a href="/">확인하기</a>',
    },
    {
      id: 7,
        ...
        {user ? (
          <form className="submitQuestion">
            ...
            <div className="question">
              <p>문의 내용</p>
              <Input type="text" placeholder="문의하실 내용을 적어주세요" />
            </div>
            <div className="agree">
